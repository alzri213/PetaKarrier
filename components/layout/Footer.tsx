...
import { TrendingUp, Heart, Sparkles, Globe2, ShieldCheck, ArrowUpRight } from "lucide-react";

export default function Footer() {
  return (
    <footer className="relative border-t border-white/10 bg-slate-50/90 px-4 pt-16 pb-12 sm:px-6 lg:px-8 text-slate-400">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="inline-flex items-center gap-2.5">
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-green-400 text-white shadow-lg shadow-emerald-500/25">
                <TrendingUp className="h-5 w-5" />
              </span>
              <span className="text-xl font-extrabold tracking-tight text-white">
                Konek<span className="text-gradient">UMKM</span>
              </span>
            </Link>
            ...
            <div className="inline-flex items-center gap-2 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 px-3.5 py-1.5 text-xs font-bold text-emerald-700">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/analisis" className="transition hover:text-white flex items-center gap-1.5">
                  Analisis Potensi Usaha
                </Link>
              </li>
              <li>
                <Link href="/kalkulator" className="transition hover:text-white flex items-center gap-1.5">
                  Kalkulator Modal & BEP
                </Link>
              </li>
              <li>
                <Link href="/perbandingan" className="transition hover:text-white flex items-center gap-1.5">
                  Komparasi Usaha vs UMR
                </Link>
              </li>
              <li>
                <Link href="/rencana-bisnis" className="transition hover:text-white flex items-center gap-1.5">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/sdg-impact" className="transition hover:text-white flex items-center gap-1.5 text-emerald-700 font-semibold">
                  Dashboard Dampak SDG 8 <ArrowUpRight className="h-3.5 w-3.5" />
                </Link>
              </li>
              <li>
                <Link href="/komunitas" className="transition hover:text-white flex items-center gap-1.5">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-xs space-y-2">
              <div className="flex items-center gap-1.5 text-white font-bold">
                <Sparkles className="h-3.5 w-3.5 text-emerald-600" /> ITechnoCup 2026
              </div>
              ...
              <div className="flex items-center gap-1 text-slate-500 pt-1">
                <ShieldCheck className="h-3.5 w-3.5 text-emerald-600" /> Data Real-time 18 Kota
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row text-xs text-slate-500">
          <p>© {new Date().getFullYear()} KonekUMKM · Selaras RAN TPB / SDG 8 Indonesia.</p>
