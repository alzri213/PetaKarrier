                    ...
                    <div className="space-y-1">
                      {conversations
                        ...
                        .map((conversation) => (
                          <div
                            key={conversation.id}
                            className={`group flex items-center gap-2 rounded-xl border px-3 py-2.5 transition ${conversation.id === activeConversationId
              ...
              {messages.map((msg, i) => (
                ...
                >
                  ...
                  <div className="max-w-[85%] space-y-1">
                    <div
                      className={`rounded-2xl px-4 py-3 text-[13px] leading-relaxed transition-all ${msg.role === "user"
